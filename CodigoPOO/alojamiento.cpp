...
void Alojamiento::eliminarReservacion(Reservacion* r, unsigned int& iteraciones) {
    for (int i = 0; i < MAX_RSVXALOJ; i++) {
        iteraciones++;
...
bool Alojamiento::eliminarReservacionPorCodigo(unsigned int cod, unsigned int& iteraciones) {
    for (int i = 0; i < MAX_RSVXALOJ; i++) {
        iteraciones++;
